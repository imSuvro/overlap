...
([`design/capture.spec.ts`](capture.spec.ts)), same viewports, same pinned timezone. The _before_
...
| Dark mode           | _not captured_                                                                                                                                                             | [desktop](audit/after/10-room-dark--desktop.png) · [tablet](audit/after/10-room-dark--tablet.png) · [mobile](audit/after/10-room-dark--mobile.png)                      |
...
in small grey text _below_ the legend. It now invites the first drag in the middle of the grid,
...
Compare the _link cut short_ pair directly. Before, it is the landing page — because it **was**
...
_is_ the brand. **Daylight** was cut as a whole because a diurnal wash under the grid breaks the
